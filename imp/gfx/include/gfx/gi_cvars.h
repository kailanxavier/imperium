...
namespace imp::gfx::gi
{
	...
	inline CVarFloat cvarVolumeExtentX{ "gi.volume_extent_x", 40.f };
	inline CVarFloat cvarVolumeExtentY{ "gi.volume_extent_y", 12.f };
	inline CVarFloat cvarVolumeExtentZ{ "gi.volume_extent_Z", 40.f };
