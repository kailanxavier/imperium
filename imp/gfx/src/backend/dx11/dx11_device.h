...
{
	class DX11Device final : public gfx::IDevice
	{
	public:
		...
		bool readbackTexture(IRenderTarget& target, std::vector<u8>& outPixels) override { return false; }
		...
		gfx::GraphicsApi api() const override { return gfx::GraphicsApi::D3D11; }
